...
setwd("C:/Users/ku52jek/Nextcloud/Geo408-w2018/R")
...
res_null <- sperrorest(formula = fo, data = d, coords = c("utmx","utmy"),
                  model_fun = fda, 
...
plot(mer_filterlda ~ ks, type="l", ylim = c(0,0.5),
...
plot(mer_rlda ~ log10(lambdas), type="l", ylim=c(0,0.5),
...
summary(fit_pca)
# The first how many PCs explain 90%, 95% of the feature set's variance?
...
plot(mer_pclda ~ ks, type="l", ylim = c(0,0.5),
